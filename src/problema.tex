...
publicado por McAfee\cite{McAfeeReport}, este señala  que una importante cantidad de
...
y no detección de flujos
implícitos\cite{dynamic-tainting},\cite{Bit-Level-Taint-Analysis},\cite{taint-analysis}.\newline
...
Partiendo del contexto que se plantea, dónde se cuenta con el código
