...
\end{abstract}
Controlar el acceso y uso a información del usuario, representa una de las
...
Un estudio reciente de seguridad en dispositivos móviles, publicado por
McAfee\cite{McAfeeReport}, señala que entre las aplicaciones que invaden la
privacidad del usuario, existen aplicaciones(no consideradas malware)
